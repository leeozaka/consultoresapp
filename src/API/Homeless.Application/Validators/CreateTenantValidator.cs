...
public sealed class CreateTenantValidator : AbstractValidator<CreateTenantCommand>
{
    ...
    public CreateTenantValidator()
    {
        ...
        RuleFor(x => x.Slug)
            ...
            .Matches(SlugRegex).WithMessage("Slug must be lowercase alphanumeric with hyphens only (e.g. 'century21-sp').");
        ...
        RuleFor(x => x.CustomDomain)
            ...
            .Matches(DomainRegex).WithMessage("Custom domain must be a valid domain name (e.g. 'portal.agency.com.br').")
