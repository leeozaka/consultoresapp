        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PricePerMonth = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AreaSqMeters = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceAtActivation = table.Column<long>(type: "bigint", nullable: false),
                    CurrencyCode = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: false),
                    Status = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_audit_logs_CommandName",
                table: "audit_logs",
                column: "CommandName");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_properties_TenantId_City_Status",
                table: "properties",
                columns: new[] { "TenantId", "City", "Status" });
